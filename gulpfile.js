...
exports.default = series(cleanApp, imagesWebp, images, parallel(html, styles, scripts, fonts, resources, watchFiles, browsersync));
exports.build = series(cleanApp, imagesWebp, imagesBuild, parallel(html, stylesBuild, scriptsBuild, fonts, resources, watchFiles, browsersync));